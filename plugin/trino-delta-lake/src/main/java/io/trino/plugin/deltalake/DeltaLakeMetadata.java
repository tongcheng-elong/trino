        ...
        implements ConnectorMetadata
{
    ...
    public void dropColumn(ConnectorSession session, ConnectorTableHandle tableHandle, ColumnHandle columnHandle)
    {
        ...
        List<DeltaLakeColumnMetadata> columns = extractSchema(table.getMetadataEntry(), typeManager);
        ImmutableList.Builder<DeltaLakeColumnHandle> columnHandlesBuilder = ImmutableList.builderWithExpectedSize(columns.size() - 1);
        ...
        for (DeltaLakeColumnMetadata column : columns) {
            ...
            if (!column.getName().equals(dropColumnName)) {
                columnHandlesBuilder.add(handle);
            }
